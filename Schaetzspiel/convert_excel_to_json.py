...
excel_file_path = "Fragen/Schätzfragen.xlsx"  # Datei mit den Schätzfragen
output_js_file = "schaetzfragen.js"  # Benenne die Ausgabe-JS-Datei für Schätzfragen
...
def convert_excel_to_js():
    try:
        ...
        # Hier filtern wir nur die Felder Kategorie, Frage und Antwort
        questions_list = questions_df[['Kategorie', 'Frage', 'Antwort']].to_dict(orient='records')

        # Formatiere die Liste als JavaScript-Variable
        js_content = "const schaetzfragen = " + json.dumps(questions_list, ensure_ascii=False, indent=4) + ";"
